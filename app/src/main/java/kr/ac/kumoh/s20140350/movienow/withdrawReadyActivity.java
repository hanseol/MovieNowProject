...
public class withdrawReadyActivity extends AppCompatActivity implements View.OnClickListener{
    //회원 가입을 위해 다시 비밀번호를 입력하는 과정
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_withdraw_ready);
